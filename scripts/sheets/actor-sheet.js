...
export class DndCustomActorSheet extends WildShapeSheetMixin(
  InventoryDragDropMixin(HandlebarsApplicationMixin(ActorSheetV2))
) {
  static DEFAULT_OPTIONS = {
    ...
    actions: {
      ...
      // mount/dismount/enterWildShape/revertWildShape/rollWildShapeAttack[Damage] :
      // enregistrés par WildShapeSheetMixin (fusion ApplicationV2 des DEFAULT_OPTIONS).
    }
  };
